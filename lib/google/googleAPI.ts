...
*/
function validatePurchase(_googleServiceAccount: any, receipt: any, cb: any) {
  ...
  _getToken(
    ...
    function (error: any, token: any) {
      ...
      request(params, function (error: any, res: any, body: any) {
        if (error) {
          return cb(error, {
            status: constants.VALIDATION.FAILURE,
            message: body,
...
function _getToken(clientEmail: any, privateKey: any, cb: any) {
...
function _getValidationUrl(receipt: any, token: any) {
  var url = "";
