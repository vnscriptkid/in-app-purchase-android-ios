...
describe("#### Apple ####", function () {
        ...
        var list = [
            {
                ...
                original_purchase_date_pst:
                    "2018-03-08 11:58:56 America/Los_Angeles",
    ...
    it("Can validate apple in-app-purchase w/ Promise & auto service detection", function (done) {
        ...
        var receipt = fs.readFileSync(fixedPath, "utf8");
    ...
    it("Can validate apple in-app-purchase", function (done) {
        ...
        iap.setup(async function (error) {
            ...
            const receipt = await fsPromises.readFile(fixedPath, {
                encoding: "utf-8",
            });
    ...
    it("[CALLBACK] Can NOT validate apple in-app-purchase with incorrect receipt w/ auto-service detection", function (done) {
    ...
    it("[PROMISE] Can NOT validate apple in-app-purchase with incorrect receipt w/ auto-service detection", async () => {
        var path = process.argv[process.argv.length - 1].replace("--path=", "");

        if (path === "false") path = fixedPath;
        ...
        try {
            await iap.validate("fake-receipt");
        } catch (err) {
            validateErr = err;
        }
        ...
        var rec = {
            ...
            latest_receipt_info: [
                ...
                },
                {
                    ...
                    original_purchase_date_pst:
                        "2016-05-14 03:03:37 America/Los_Angeles",
